...
{
  User_Profile_Screen({Key? key , required this.userModel}) : super(key: key);
                    ...
                    child: Stack(
                      ...
                      children: [
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: NetworkImage('${userModel!.cover!.replaceAll('"', '')}'),
                                  fit: BoxFit.cover,
                        ...
                        CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 60.0,
                            backgroundImage: NetworkImage('${userModel!.image!.replaceAll('"', '')}'),
                          ),
                        ),
                      ],
                    ),
